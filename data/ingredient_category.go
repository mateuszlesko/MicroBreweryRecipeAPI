...
func SelectIngredientCategories() ([]IngredientCategory, error) {
...
func SelectIngredientCategoryWhereID(id int) (*IngredientCategory, error) {
	err, db := helpers.OpenConnection()
	defer db.Close()
	if err != nil {
		return nil, err
...
func UpdateIngredientCategory(category IngredientCategory) (*IngredientCategory, error) {
	err, db := helpers.OpenConnection()
	if err != nil {
		return nil, err
	}
...
func InsertIngredientCategory(name string) error {
	err, db := helpers.OpenConnection()
	if err != nil {
		return err
	}
