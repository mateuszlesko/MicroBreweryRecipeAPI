...
func SelectIngredientById(id int) (*Ingredient, error) {
	...
	ingredient := &Ingredient{ingredient_id, ingredient_name, ingredient_unit, ingredient_quantity, ingredient_created_at, &IngredientCategory{category_id, category_name, time.Time{}}}
	defer db.Close()
